...
review(black_kettle_05_zs_id1,rbind6)
review(black_kettle_04_05_zs_id1,rbind6)
review(kiowa_rb_nm_west_zs_id1,rbind6)
review(kiowa_rb_east_e_zs_id1,rbind6)
review(mcclellen_creek_zs_id1,rbind6)
review(nf_mag_zs_id1,rbind6)
review(nf_san_zs_id1,rbind6)
###################################Review##########################################
...
write.csv(rbind4, file = "cib_ng_zs1.csv")
write.table(rbind4, file = "cib_phodar_zs_nona.txt",sep="\t",na="-999")
